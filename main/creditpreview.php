  ...
  <!-- page content here -->
    <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Dasboard/</h2><span>Credit Preview</span>
...
<div class="pull-left" style="margin-left:200px; margin-top:200px; color:green; font:bold 50px 'Aleo';">
	<center> <label style="color:blue; font:bold 50px 'Aleo';"><strong>Transaction successfully saved</strong></label></center>
		</div>	
</div>
</div>
