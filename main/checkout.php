...
<input type="hidden" name="amount" id="amount" value="<?php echo $_GET['total']; ?>" />
...
<input type="text" name="cash" placeholder="Cash" value="" id="cash"  onchange="myFunction(this)" style="width: 268px; height:30px;  margin-bottom: 15px;"  required/><br>
<?php
}
?><button class="btn btn-success btn-block btn-large" id="choose" style="width:267px;" disabled><i class="icon icon-save icon-large"></i> Save</button>
</center>
</div>
</form>
<script>
function myFunction(x) {
	...
	b=Number(document.getElementById("cash").value);
