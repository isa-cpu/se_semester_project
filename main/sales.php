...
Discount<input type="text" class="number" name="discount" min="0" value="0" autocomplete="off" style="width: 68px; height:25px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px;" />
...
<table class="table table-bordered" id="resultTable" data-responsive="table">
	...
	<tbody>
			...
			<?php
				...
				sales_order.transaction_id,
				sales_order.invoice,
				sales_order.product,
				sales_order.qty,
				sales_order.amount,
				sales_order.product_code,
				sales_order.`name`,
				sales_order.price,
				...
				FROM
				sales_order
				WHERE sales_order.invoice= :userid");
			...
			<td width="90"><a href="delete.php?id=<?php echo $row['transaction_id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&dle=<?php echo $_GET['id']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>&pcode=<?php echo $row['product_code'];?>"><button class="btn btn-mini btn-warning"><i class="icon icon-remove"></i> Cancel </button></a></td>
			</tr>
			<?php
				}
			?>
	...
	<a rel="facebox" href="checkout.php?pt=<?php echo $_GET['id']?>&invoice=<?php echo $_GET['invoice']?>&total=<?php echo $fgfg ?>&cashier=<?php echo $_SESSION['SESS_FIRST_NAME']?>"><button class="btn btn-success btn-large pull-right"><i class="icon icon-save icon-large"></i> SAVE</button></a>
