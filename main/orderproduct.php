  ...
  <!-- page content here -->
    <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Dasboard/</h2><span>Request</span>
...
<table id="app">
					...
					<td>
						<select name="name[]" id="name_1" class="form-control" onchange="get_detail_name(this.value,1)" style="width: 300px; height:35px;">
					...
					<td>
						<input type="hidden" required class="form-control" onkeyup="get_quantity(this.value,1)" step="0.01" id="sale_price_1" name="sale_price[]" style=" height:25px;" />
...
<Button type="submit" class="btn btn-info" style="width: 250px; height:35px; margin-top:-5px;" /><i class="icon-plus-sign icon-large"></i> Add Items To Be Requested</button>
</form>
<!-- <button  type="hidden" style="float:right;" class="btn btn-success btn-mini"><a href="javascript:Clickheretoprint()"> Print</button></a></br> -->
<div class="content" id="content">
<div style="text-align:center;">
			<font style="color:rgb(255, 95, 66);text-align:center; font:bold 22px 'Aleo';">REQUESTED BY: [<?php echo date('Y/m/d').' - '.$_SESSION['firstname']." ".$_SESSION['lastname'];?>]</font>
			</div>
<table class="table table-bordered" id="resultTable" data-responsive="table">
	...
	<tbody>
			...
			<?php
				...
				orderproduct.bar_code,
				orderproduct.id,
				orderproduct.name
				FROM
				orderproduct
				WHERE orderproduct.invoice= :userid");
			...
			<td width="90"><a href="deleteorder.php?id=<?php echo $row['id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&dle=<?php echo $_GET['id']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>&pcode=<?php echo $procode;?>"><button class="btn btn-mini btn-warning"><i class="icon icon-remove"></i> Cancel </button></a></td>
			</tr>
			<?php
				}
			?>
...
<a  href="success.php"><button class="btn btn-success btn-large pull-right"><i class="icon icon-save icon-large"></i> Request</button></a>
<div class="clearfix"></div> 
